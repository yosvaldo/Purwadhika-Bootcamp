...
app.use(
	(
		...
		// Handle tipe error yang spesifik, misal error validasi request body dari Yup
		// Hasil error validasi harusnya berstatus 400 Bad Request,
		// bukan 500 Internal Server Error
		// Karena error instance bisa datang dari Error class berbeda maka isi error object-nya juga
		// akan berbeda juga. Kita harus rajin baca dokumentasi library yang kita pakai
		// untuk mengetahui tipe error apa saja yang mungkin dilemparkan oleh library tersebut
		// dan mengetahui bentuk isi error object-nya supaya bisa kita handle dengan tepat
